...
const appealSchema = z.object({
  ...
  pe2Form: z.object({
    ...
    applicantPostcode: z.string(),
    judgmentDate: z.string(),
    judgmentAmount: z.string(),
    reasonForApplication: z.string(),
    groundsForApplication: z.string(),
    evidenceSupporting: z.string(),
    believeFactsTrue: z.boolean(),
    understandContempt: z.boolean(),
  ...
  pe3Form: z.object({
    ...
    penaltyChargeNumber: z.string(),
    vehicleRegistration: z.string(),
    dateOfContravention: z.string(),
    locationOfContravention: z.string(),
    penaltyAmount: z.string(),
    reasonForDeclaration: z.string(),
    circumstancesDescription: z.string(),
    didNotReceiveNotice: z.boolean().optional(),
    wasNotDriver: z.boolean().optional(),
    vehicleNotAtLocation: z.boolean().optional(),
  ...
  n244Form: z.object({
    ...
    orderSought: z.string(),
    reasonsForApplication: z.string(),
    legalAuthorityReliedOn: z.string(),
    hearingRequired: z.boolean(),
    estimatedHearingTime: z.string(),
    evidenceInSupport: z.string(),
    costsClaimed: z.boolean(),
  ...
  try {
    ...
    const appeal = await prisma.appeal.create({
      data: {
        ...
        pe2Form: appealData.pe2Form ? JSON.stringify(appealData.pe2Form) : null,
        pe3Form: appealData.pe3Form ? JSON.stringify(appealData.pe3Form) : null,
        n244Form: appealData.n244Form ? JSON.stringify(appealData.n244Form) : null,
